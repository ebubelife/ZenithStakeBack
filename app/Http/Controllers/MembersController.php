    ...
    public function send_email_to_all_affiliates(Members $members){
      ...
      /* $members = Members::where('is_vendor', false)
        ...
        /*   array("email"=>"holuwasayofunmiprecious@gmail.com", "first_name"=>"Precious", "ticket"=>"https://zenithstake.com/images/precious-ogunleye-ticket.jpeg"),
           ...
           array("email"=>"obiomaprecious234@gmail.com", "first_name"=>"Obioma Precious", "ticket"=>"https://zenithstake.com/images/tickets/obioma-ticket.jpeg"),
        
           array("email"=>"officialnicequeen@gmail.com", "first_name"=>"Chiamaka", "ticket"=>"https://zenithstake.com/images/tickets/igwechima-ticket.jpeg"),
        
           array("email"=>"aderonkefaith1@gmail.com", "first_name"=>"Faith", "ticket"=>"https://zenithstake.com/images/tickets/aderonke-faith-ticket.jpeg"),
        
           array("email"=>"juliesilver74@gmail.com", "first_name"=>"Julian", "ticket"=>"https://zenithstake.com/images/tickets/julian-ticket.jpeg"),


           array("email"=>"amuziefrancisca01@gmail.com", "first_name"=>"Francisca", "ticket"=>"https://zenithstake.com/images/tickets/amuzie-ticket.jpeg"),


           array("email"=>"xarmzon@gmail.com", "first_name"=>"Adelola", "ticket"=>"https://zenithstake.com/images/tickets/kayode-samson-ticket.jpeg"),
...
else if($validated["req_source"] == "ADMIN"){
